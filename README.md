...
This is a mod, which will add many resources, crafts and other interesting things to the game.<br>
In plan I have to add many chemical elements and compounds to diversify the game experience.<br>
Current stage - mod prototyping, adding the resin and related crafts (making rubber, refined resin, melted resin and other).<br>
!Below you can see what maked and what is only planned to make in ~near time.<br>

Это мод, который добавит множество новых ресурсов, крафтов и прочих интересных вещей в игру.<br>
Я намерен добавить много химических элементов и соединений для разнообразия игрового опыта.<br>
Текущий статус - прототипирование мода, добавление смолы и связанных крафтов (создание резины, очистка смолы, расплав смолы и прочее).<br>
!Ниже вы можете видеть то, что уже присутствует в моде, так и то, что только планируется.<br>

# Resin / Смола
![Resin-ore icon](https://raw.githubusercontent.com/DemerNkardaz/PLORD/misc/icns/resin-ore.png?raw=true)<br><br>
This is a new resource what you can to collect from trees, stones and you can find some ore-like resin deposits, which able to harvested by drills.<br>
With unlock starting tecnhology "Resin Harvesting" give you ability to refine wood to resin. It some risky - you have chance to nothing result with spending of wood.<br>
Resin is will be important resource for some crafts in later updates.<br>
All resins can be consumed as a fuel, but this is a bad idea - very low power gain and high-rate consuming of item. However, it can be fixed with some complex crafts to useful fuel recipe with coal's derivative...<br><br>
Это новый ресурс, который можно добывать срубая деревья, копая булыжники, а также можно обнаружить рудоподобные залежи смолы, на которые можно ставить буры.<br>
С исследованием стартовой технологии "Добыча смолы" вам даётся способность перерабатывать древесину в смолу. Это рисковано - всегда есть шанс потратить древесину без результата.<br>
Смола станет важным ресурсом для ряда крафтов в будущих обновлениях.<br>
...
Liquified and hot (125°C) resin needed for some productions (Refined Resin, etc.).<br>
...
The important resource for making high-quality resin productions (fuel, high-quality rubber, etc.).<br>
Warning - the Resin slag is too much, you need very fast inserter for out it from production!<br>

Важный ресурсы для создания высококачественных смоляных продуктов (топливо, высококачественная резина и т.д.).<br>
Предупреждение - очень много смоляного шкала, вам необходим очень быстрый манипулятор, что бы убирать его с производства!<br>

# High-quality Melted Resin / Высококачественный расплав смолы
![Resin-melted-high quality icon](https://raw.githubusercontent.com/DemerNkardaz/PLORD/misc/icns/resin-melted-high-quality.png?raw=true)<br><br>
Liquified and hot (125°C) refined resin needed for some productions.<br>
...
###  Current status
Early alpha-prototype | UNSTABLE

###  Localization
🇷🇺 RU | 🇬🇧 EN (in future)

###  Recommended stable-work mods
